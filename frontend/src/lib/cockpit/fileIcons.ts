...
const BY_EXT: Record<string, IconSpec> = {
  ...
  png: { glyph: 'IMG', color: '#37b24d' },
  jpg: { glyph: 'IMG', color: '#37b24d' },
  jpeg: { glyph: 'IMG', color: '#37b24d' },
  gif: { glyph: 'IMG', color: '#37b24d' },
  webp: { glyph: 'IMG', color: '#37b24d' },
  heic: { glyph: 'IMG', color: '#37b24d' },
  svg: { glyph: 'IMG', color: '#37b24d' },
  mp4: { glyph: 'VID', color: '#7048e8' },
  mov: { glyph: 'VID', color: '#7048e8' },
  zip: { glyph: 'ZIP', color: '#f08c00' },
  tar: { glyph: 'ZIP', color: '#f08c00' },
  gz: { glyph: 'ZIP', color: '#f08c00' },
}
